...
QT_MOC_LITERAL(1, 8, 14), // "slot_updatePen"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5) // "Data*"

    },
    "Pattern\0slot_updatePen\0\0Data*"
};
...
void Pattern::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slot_updatePen((*reinterpret_cast< Data*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
